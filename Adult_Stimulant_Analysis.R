...
data_2019 <- raw_data_2019 %>% 
  select(AGE, RACERETH, SEX, MSA, PAYTYPER,  # Demographic characteristics
         ...
         MDDO,PRIMCARE,PHYSASST,NPNMW,MHP,OTHPROV,RNLPN,  # Provider characteristics
...
data_combined <- data_combined %>% 
  ...
  # Create grouped categorical variables for age
...
### Multivariable logistic regression of factors associated with any (prevalent) stimulant prescription ###
write.csv(
